...
module.exports = (client) => {
  const APPLICATION_CHANNEL = '1255162116126539786'; // Replace with the ID of the application channel
  ...
  const PENDING_IMAGE_URL = 'https://i.ibb.co/zm3LBZw/pending.png'; // Replace with the URL of the pending background image
  const REJECT_IMAGE_URL = 'https://i.ibb.co/M6WWZ9b/reject.png'; // Replace with the URL of the reject background image
